...
points_par_club <- points_par_club %>% 
  mutate(club = case_when(
    ...
    club == "ELITE VAL-D'OISE (N" ~ "ELITE VAL-D'OISE",
    club =="ELITE VAL-D'OISE (N1M)" ~ "ELITE VAL-D'OISE",
    club == "LORMONT HB (N" ~"LORMONT HB",
    club == "GRAND POITIERS HANDBALL 86" ~ "GRAND POITIERS HANDBALL",
    club == "HANDBALL HAZEBROUCK 71" ~ "HANDBALL HAZEBROUCK",
    club =="SAVIGNY HB 91" ~"SAVIGNY HB",
    ...
    club == "SAVIGNY HB 91" ~ "SAVIGNY HB",
    club == "GRAND LIBOURNAIS HB (N" ~ "GRAND LIBOURNAIS HB",
    club == "GRAND LIBOURNAIS HB (N1M)" ~ "GRAND LIBOURNAIS HB",
    club == "MAINVILLIERS-CHARTRES HANDBALL 2" ~ "MAINVILLIERS-CHARTRES HANDBALL",
    TRUE ~ club
  )) %>% 
...
```{r}
df2 <- read.csv("Data/data_diff_point_norme.csv", row.names = 1)
