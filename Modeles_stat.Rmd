...
mod0 <- glm(effet_positif ~ TM_derniere_min + TM_derniere_min_adverse + HF + equipe + diff_classement + DM_adverse + DM, data = data_mod1, family = "binomial")
summary(mod0)
```
...
mod1 <- glm(effet_positif ~ TM_derniere_min + TM_derniere_min_adverse + HF + equipe + diff_classement + DM_adverse + DM + statut_59_min, data = data_mod1, family = "binomial")
summary(mod1)
