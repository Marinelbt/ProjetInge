...
classement_D1H_2223 <- read.table("classement_D1H_2223.csv", header = TRUE, sep = ",")
classement_D1H_2324 <- read.table("classement_D1H_2324.csv", header = TRUE, sep = ",")
classement_D1F_2223 <- read.table("classement_D1F_2223.csv", header = TRUE, sep = ",")
classement_D1F_2324 <- read.table("classement_D1F_2324.csv", header = TRUE, sep = ",")
classement_D2H_2223 <- read.table("classement_D2H_2223.csv", header = TRUE, sep = ",")
classement_D2H_2324 <- read.table("classement_D2H_2324.csv", header = TRUE, sep = ",")
classement_D2F_2223 <- read.table("classement_D2F_2223.csv", header = TRUE, sep = ",")
...
classement_D1H_2122 <- read.table("classement_D1H_2122.csv", header = TRUE, sep = ",")
classement_D1F_2122 <- read.table("classement_D1F_2122.csv", header = TRUE, sep = ",")
classement_D2H_2122 <- read.table("classement_D2H_2122.csv", header = TRUE, sep = ",")
classement_D2F_2122 <- read.table("classement_D2F_2122.csv", header = TRUE, sep = ",")
...
mod0 <- glm(effet_positif ~ TM_derniere_min + TM_derniere_min_adverse + HF + diff_classement + DM_adverse + DM, data = data_mod1, family = "binomial")
summary(mod0)
```
...
mod1 <- glm(effet_positif ~ TM_derniere_min + TM_derniere_min_adverse + HF + diff_classement + DM_adverse + DM + statut_59_min, data = data_mod1, family = "binomial")
summary(mod1)
