...
# Chercher le meilleur seuil avec courbe ROC

```{r}
# Utiliser la fonction roc de la librairie pROC pour calculer la courbe ROC
library(pROC)
roc_curve <- roc(test_data$effet_positif, pred_prob[, "1"])
plot(roc_curve)
