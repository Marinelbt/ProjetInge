...
roc_curve <- roc(test_data$effet_positif, pred_prob[[2]])
...
pred_class <- ifelse(pred_prob[[2]] > optimal_threshold, 1, 0)

# Calcul de l'accuracy et table de confusion
accuracy <- mean(test_data$effet_positif == as.factor(pred_class))
...
# Test sur un match qui ne s'est pas encore produit 
