...
```{r}
data_mod2$equipe <- factor(data_mod2$equipe)
...
data_mod2$diff_point_norm <- scale(data_mod2$diff_point)
```
...
```{r}
mod2 <- glm(effet_positif ~ TM_derniere_min + TM_derniere_min_adverse + HF + DM_adverse + DM + diff_point_norm, data = data_mod2, family = "binomial")
summary(mod2)

best_mod2 <- stepwise(mod2, direction = "backward/forward", criterion = "AIC")
best_mod2
```
...
mod_egalite3 <- glm(effet_positif ~ TM_derniere_min + TM_derniere_min_adverse + HF + DM_adverse + DM + diff_point_norm, data = data_egalite_2, family = "binomial")
summary(mod_egalite3)

best_mod_egalite3 <- stepwise(mod_egalite3, direction = "backward/forward", criterion = "AIC")
best_mod_egalite3
```
...
mod_perdant3 <- glm(effet_positif ~ TM_derniere_min + TM_derniere_min_adverse + HF + DM_adverse + DM + diff_point_norm, data = data_perdant_2, family = "binomial")
summary(mod_perdant3)

best_mod_perdant3 <- stepwise(mod_perdant3, direction = "backward/forward", criterion = "AIC")
best_mod_perdant3
```
...
mod_gagnant3 <- glm(effet_positif ~ TM_derniere_min + TM_derniere_min_adverse + HF + DM_adverse + DM + diff_point_norm, data = data_gagnant_2, family = "binomial")
summary(mod_gagnant3)

best_mod_gagnant3 <- stepwise(mod_gagnant3, direction = "backward/forward", criterion = "AIC")
best_mod_gagnant3
```