...
pdf("modele_59.pdf", width = 10, height = 7)
ggcoef_compare(
  list(
  ...
  coord_cartesian(xlim = c(-3,3)) +  # Limiter l'axe des abscisses
  scale_x_continuous(
    breaks = seq(-3,3, by = 1),      # Ajouter des ticks tous les 1
    minor_breaks = seq(-3,3, by = 0.5)  # Sous-ticks tous les 0.5
  )
dev.off()
```
