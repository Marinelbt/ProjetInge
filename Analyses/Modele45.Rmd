...
data_mod4$diff_point_norm <- scale(data_mod4$diff_point)
```
...
mod4_full <- glm(effet_positif ~ TM_derniere_min + TM_derniere_min_adverse + HF + DM_adverse + DM + diff_point_norm, data = data_mod4, family = "binomial")
#summary(mod4)
...
mod_egalite5 <- glm(effet_positif ~ TM_derniere_min + TM_derniere_min_adverse + HF + DM_adverse + DM + diff_point_norm, data = data_egalite_4, family = "binomial")
...
mod_perdant5 <- glm(effet_positif ~ TM_derniere_min + TM_derniere_min_adverse + HF + DM_adverse + DM + diff_point_norm, data = data_perdant_4, family = "binomial")
...
mod_gagnant5 <- glm(effet_positif ~ TM_derniere_min + TM_derniere_min_adverse + HF + DM_adverse + DM + diff_point_norm, data = data_gagnant_4, family = "binomial")
